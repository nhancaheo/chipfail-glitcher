...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot  xil_defaultlib. xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim  -key {Behavioral:sim_1:Functional:} -tclbatch cmd.tcl -log simulate.log
}
